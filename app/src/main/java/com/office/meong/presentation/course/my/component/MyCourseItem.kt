package com.office.meong.presentation.course.my.component
...
@Composable
private fun MyCourseTopSection(
    location: String,
    tripPeriod: String,
    title: String,
    grade: String,
...
@Composable
private fun MyCourseCategorySection(
    places: ImmutableList<MyCoursePlaceCategory>,
    modifier: Modifier = Modifier
) {
    Row(
...
@Composable
private fun MyCourseCategoryBadgeItem(
    label: String,
...
@Composable
private fun MyCourseBottomSection(
    totalCount: Int,
    modifier: Modifier = Modifier
) {
    Row(
...
@Preview
@Composable
private fun MyCourseItemPreview() {
    MeongTheme {
        MyCourseItem(
            location = "강릉",
